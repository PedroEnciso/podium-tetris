...
const RightSide = ({ lines, level, score, nextTetromino }) => {
  return (
    <section className="right-side side">
      <InGameData lib="Lines" data={lines} />
      <InGameData lib="Level" data={level} />
      <InGameData lib="Score" data={score} />
...
export default connect(mapStateToProps, undefined)(RightSide);
