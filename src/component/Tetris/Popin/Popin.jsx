        ...
        <section className="popin">
          {popinState === "gameOver" && (
            <Fragment>
              ...
              <p>
                The Politburo will never forget your sacrifice for creating
                order out of chaos.
              </p>
              <span className="btn" onClick={closePopin}>
                Play again
              </span>
            </Fragment>
          )}
          {popinState === "about" && (
            <Fragment>
              <p>
                This game is a tribute to Tetris and is not affiliated with the
                Tetris Company.
              </p>
              <p>I did it to learn how to develop with React.</p>
              <p>
                I used the font{" "}
                <a href="http://www.tenbytwenty.com/#munro">Munro</a> created by{" "}
                <a href="http://edmerritt.com/">Ed Merritt</a> and an icon from
                Saint Basil Cathedral made by{" "}
